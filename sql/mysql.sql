...
CREATE TABLE `wgsimpleacc_files` (
  ...
  `fil_type`        VARCHAR(100)    NOT NULL DEFAULT '',
...
CREATE TABLE `wgsimpleacc_tratemplates` (
  ...
  `ttpl_cliid`       INT(10)         NOT NULL DEFAULT '0',
  `ttpl_class`       INT(1)          NOT NULL DEFAULT '0',
...
CREATE TABLE `wgsimpleacc_outtemplates` (
  ...
  `otpl_accid`       VARCHAR(255)    NOT NULL DEFAULT '',
...
#
# Structure table for `wgsimpleacc_clients` 12
#

CREATE TABLE `wgsimpleacc_clients` (
