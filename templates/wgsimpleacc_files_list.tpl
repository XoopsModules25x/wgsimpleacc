<tr>
    ...
    <td scope="col">
        ...
        <{else}>
            <a class='btn btn-default' href='files.php?op=showfile&amp;fil_id=<{$file.id}>&amp;start=<{$start}>&amp;limit=<{$limit}>' target="_blank" title='<{$file.name}>'><i class="fa fa-download fa-fw"></i></a>
        <{/if}>
